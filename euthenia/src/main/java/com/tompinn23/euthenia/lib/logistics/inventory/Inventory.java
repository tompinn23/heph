package com.tompinn23.euthenia.lib.logistics.inventory;

import com.tompinn23.euthenia.lib.block.AbstractTile;
import com.tompinn23.euthenia.lib.item.Stacks;
...
public class Inventory extends ItemStackHandler {
    ...
    public Inventory(int size, @Nullable IInventoryHolder tile) {
        super(size);
        this.tile = tile;
    }

    public static <I extends AbstractTile & IInventoryHolder> Inventory create(int size, @Nullable I tile) {
        return new Inventory(size, tile);
    }

    public static <I extends AbstractTile & IInventoryHolder> Inventory createBlank(@Nullable I tile) {
